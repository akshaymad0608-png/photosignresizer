...
const StepCard = ({ icon: Icon, title, description, step }: StepCardProps) => (
  <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700 relative group hover:shadow-sm hover:-translate-y-2 transition-all duration-300">
    <div className="absolute -top-5 -left-5 w-12 h-12 bg-brand text-white rounded-2xl flex items-center justify-center font-black text-xl shadow-sm group-hover:scale-110 group-hover:rotate-6 transition-transform">
      {step}
    </div>
