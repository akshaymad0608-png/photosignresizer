  ...
  <div className="bg-white dark:bg-gray-900/50 rounded-3xl md:rounded-[3rem] p-6 sm:p-12 md:p-20 shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 mb-16 sm:mb-24 relative overflow-hidden group/section">
    ...
    <div className="max-w-5xl mx-auto text-center relative z-10">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-16 md:mb-20 tracking-tight leading-tight flex items-center justify-center gap-4">
        <div className="p-3 bg-gradient-to-br from-brand/20 to-brand/5 dark:from-cyan-500/20 dark:to-cyan-500/5 rounded-2xl border border-brand/10 dark:border-cyan-500/20 shadow-sm hidden sm:block">
