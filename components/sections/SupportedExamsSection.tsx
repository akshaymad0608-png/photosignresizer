...
const SupportedExamsSection = () => (
  <div className="bg-white dark:bg-gray-900/50 rounded-3xl md:rounded-[3rem] p-6 sm:p-12 md:p-16 shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 mb-16 sm:mb-24 relative overflow-hidden group/section">
    ...
    <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 dark:text-white mb-8 sm:mb-16 text-center tracking-tight relative z-10">Supported Government Exams</h2>
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-6 relative z-10">
      {Object.values(EXAM_PRESETS).map((exam, idx) => (
        <div key={idx} className="group bg-gray-50/50 dark:bg-gray-900/30 p-4 sm:p-6 rounded-2xl border border-gray-100 dark:border-gray-800 flex flex-col items-center justify-center text-center hover:bg-white dark:hover:bg-gray-800 hover:shadow-xl hover:shadow-brand/5 dark:hover:shadow-cyan-500/5 hover:-translate-y-1 transition-all duration-500 relative overflow-hidden">
