...
const AdPlaceholder: React.FC<AdPlaceholderProps> = ({ text }) => {
  return (
    <a 
      ...
      className="block w-full max-w-4xl mx-auto my-12 overflow-hidden rounded-3xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-xl shadow-gray-200/40 dark:shadow-none group cursor-pointer transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-gray-200/50"
    >
