        ...
        <div className="mt-4 space-y-4 bg-gray-50 dark:bg-gray-800 p-5 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <label className="flex items-center gap-3 cursor-pointer select-none">
              <div className="relative flex items-center">
                <input 
                  ...
                  className="peer w-5 h-5 appearance-none border border-gray-300 dark:border-gray-600 rounded-md checked:bg-brand dark:checked:bg-cyan-500 checked:border-brand transition-colors cursor-pointer bg-white dark:bg-gray-700"
                />
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer accent-brand dark:accent-cyan-500"
            />
          </div>
