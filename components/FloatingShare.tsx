    ...
    <div className="fixed left-4 sm:left-6 bottom-6 z-50 flex flex-col-reverse items-center gap-3">
      ...
      <div className={`flex flex-col gap-3 transition-all duration-300 origin-bottom ${
        ...
        <button 
          ...
          className="w-10 h-10 rounded-full bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 flex items-center justify-center shadow-lg border border-gray-200 dark:border-gray-700 hover:-translate-y-1 hover:text-brand dark:hover:text-cyan-400 transition-all relative group"
          title="Copy Link"
        >
          <Link2 size={16} />
          {showCopied && (
        ...
        <a 
          ...
          className="w-10 h-10 rounded-full bg-[#0088cc] text-white flex items-center justify-center shadow-lg hover:-translate-y-1 hover:shadow-[#0088cc]/50 transition-all"
        ...
        <a 
          ...
          className="w-10 h-10 rounded-full bg-[#1877F2] text-white flex items-center justify-center shadow-lg hover:-translate-y-1 hover:shadow-[#1877F2]/50 transition-all"
        ...
        <a 
          ...
          className="w-10 h-10 rounded-full bg-[#1DA1F2] text-white flex items-center justify-center shadow-lg hover:-translate-y-1 hover:shadow-[#1DA1F2]/50 transition-all"
        ...
        <a 
          ...
          className="w-10 h-10 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg hover:-translate-y-1 hover:shadow-[#25D366]/50 transition-all"
