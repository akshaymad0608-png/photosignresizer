...
export default function PlatformNavbar() {
  return (
    <nav className="border-b border-gray-200/50 dark:border-gray-800/50 bg-white/90 dark:bg-gray-950/90 backdrop-blur-3xl z-50 py-2 sm:py-3 sticky top-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center">
        <Link to="/" className="flex items-center gap-2 cursor-pointer group">
          <div className="p-2 rounded-xl transition-all duration-500 bg-gradient-to-br from-brand to-accent text-white shadow-lg shadow-brand/20">
