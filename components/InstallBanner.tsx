...
export default function InstallBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-[132px] lg:bottom-5 left-3 right-3 sm:left-auto sm:right-5 sm:w-[360px] z-50 glass-strong rounded-2xl shadow-xl border border-line p-4 animate-fade-in-up"
    >
      <button
        type="button"
        onClick={dismiss}
        aria-label="Dismiss install prompt"
        className="absolute top-1 right-1 w-11 h-11 rounded-lg text-fg-faint hover:text-fg hover:bg-surface-2 flex items-center justify-center transition-colors"
      >
        <X size={15} />
      </button>
