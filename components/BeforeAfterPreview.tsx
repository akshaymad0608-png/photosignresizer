...
const BeforeAfterPreview: React.FC<BeforeAfterPreviewProps> = ({ originalUrl, processedUrl, className = "", onClick }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute top-2 left-2 bg-black/60 text-white text-[10px] font-bold px-2 py-1 rounded-md backdrop- z-10">
        BEFORE
      </div>
      ...
      >
        ...
        />
        <div className="absolute top-2 right-2 bg-brand/90 text-white text-[10px] font-bold px-2 py-1 rounded-md backdrop- z-10">
          AFTER
        </div>
      </div>
      ...
      >
        ...
        <div className="w-8 h-8 bg-white text-gray-800 rounded-full shadow-sm flex items-center justify-center transition-transform group-hover:scale-110 active:scale-95">
