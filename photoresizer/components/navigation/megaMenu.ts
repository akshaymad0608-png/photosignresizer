    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: 'Image compressor', desc: 'Hit a target KB without mush', href: '/tools/compress', icon: Minimize2 },
          { label: 'Format converter', desc: 'JPG, PNG and WebP', href: '/tools/convert', icon: Repeat },
        ],
      },
      {
        heading: 'Utilities',
        items: [
          { label: 'Metadata remover', desc: 'Strip EXIF and GPS data', href: '/tools/metadata', icon: ShieldOff },
          { label: 'Watermark', desc: 'Protect documents you share', href: '/tools/watermark', icon: Droplets },
          { label: 'Colour palette', desc: 'Pull dominant colours', href: '/tools/palette', icon: Palette },
          { label: 'QR generator', desc: 'Links, UPI and text', href: '/tools/qr', icon: QrCode, badge: 'New' },
        ],
      },
      {
        heading: 'Documents',
