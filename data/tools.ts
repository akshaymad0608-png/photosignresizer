...
export const TOOLS: Tool[] = [
  ...
  // ---- Added 05 Aug 2026 — all canvas-based, so all genuinely work --------
  {
    id: 'png-to-webp',
    name: 'PNG to WebP',
    blurb: 'Re-encode a PNG as WebP for a much smaller file at the same quality.',
    group: 'Convert',
    output: 'webp',
    quality: 0.9,
    accept: 'image/png',
  },
  {
    id: 'sepia-filter',
    name: 'Sepia Filter',
    blurb: 'Give a photo a warm, vintage sepia tone in one click.',
    group: 'Edit',
    output: 'same',
    quality: 0.92,
    filter: 'sepia(100%)',
  ...
  },
  {
    id: 'invert-colors',
    name: 'Invert Colours',
    blurb: 'Flip a photo to its negative — swap every colour for its opposite.',
    group: 'Edit',
    output: 'same',
    quality: 0.92,
    filter: 'invert(100%)',
  ...
  },
  {
    id: 'blur-image',
    name: 'Blur Image',
    blurb: 'Soften a photo or hide sensitive details with a gentle blur.',
    group: 'Edit',
    output: 'same',
    quality: 0.92,
    filter: 'blur(4px)',
  ...
  },
  {
    id: 'brighten-image',
    name: 'Brighten Image',
    blurb: 'Lighten a dark or underexposed photo without editing software.',
    group: 'Edit',
    output: 'same',
    quality: 0.92,
  ...
  },
  {
    ...
    blurb: 'Make a flat, washed-out photo pop with stronger contrast.',
    group: 'Edit',
    output: 'same',
    quality: 0.92,
    filter: 'contrast(140%)',
  ...
  {
    id: 'add-black-background',
    name: 'Add Black Background',
    blurb: 'Flatten a transparent PNG onto solid black where a form needs it.',
    group: 'Edit',
    output: 'jpeg',
    quality: 0.92,
    background: '#000000',
  ...
  },
  {
    ...
    blurb: 'Turn an upside-down scan or photo the right way up.',
    group: 'Edit',
    output: 'same',
    quality: 0.95,
    rotate: 180,
  ...
  {
    id: 'profile-photo-500',
    name: 'Profile Photo 500x500',
    blurb: 'A crisp square 500x500 photo for WhatsApp, LinkedIn or any profile.',
    group: 'Resize',
    output: 'jpeg',
    quality: 0.9,
  ...
  },
  {
    ...
    blurb: 'Crop and resize any image to the square 1080x1080 Instagram size.',
    group: 'Resize',
    output: 'jpeg',
    quality: 0.9,
  ...
  },
  {
    ...
    blurb: 'Crop and resize an image to the 1280x720 YouTube thumbnail size.',
    group: 'Resize',
    output: 'jpeg',
    quality: 0.9,
  ...
  },
  {
    id: 'favicon-32',
    name: 'Favicon 32x32',
    blurb: 'Shrink a logo or image to a 32x32 favicon for your website.',
    group: 'Resize',
    output: 'png',
  ...
  {
    id: 'us-visa-photo-600',
    name: 'US Visa Photo 600x600',
    blurb: 'Resize to the 2x2 inch (600x600 px) US visa photo size on white.',
    group: 'Resize',
    output: 'jpeg',
    quality: 0.92,
